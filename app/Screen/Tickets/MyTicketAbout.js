...
const MyTicketAbout = props => {
  const {showLive, pending, order} = props.route.params;
      ...
      <View style={{alignSelf: 'center', flex: 1}}>
        <ScrollView>
          ...
          <View
            ...
            {LIST.filter(
              it => it.live == showLive || it.pending == pending,
            ).map((it, key) => (
